...
from dispensa.ai.batch import PROMPT_VERSION, log_batch_status
from dispensa.app import (
    backfill_images,
    embed,
    extraction,
    ingest,
...
app = typer.Typer(help="Dispensa command-line tools.")
