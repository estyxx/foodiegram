...
from dispensa.domain.pantry import kitchen_match
from dispensa.domain.synonyms import SYNONYM_GROUPS, canonical_term
...
if TYPE_CHECKING:
    ...
    from dispensa.domain.planning import WeekPlan
